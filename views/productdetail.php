    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix">
                <div class="product__item sale" onclick="window.location.href='index.php?url=chitietsanpham&id_sp=<?=$product_id?>&id_dm=<?=$category_id?>'">
                    ...
                    <div class="product__item__text" onclick="window.location.href='index.php?url=chitietsanpham&id_sp=<?=$product_id?>&id_dm=<?=$category_id?>'">
                        <h6 class="text-truncate-1" onclick="window.location.href='index.php?url=chitietsanpham&id_sp=<?=$product_id?>&id_dm=<?=$category_id?>'">
